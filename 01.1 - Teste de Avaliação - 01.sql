...
/* 02 - You want to print out a list of all of the facilities and their cost to 
...
/* 04 - How can you produce a list of facilities that charge a fee to members, and 
...
/* 06 - How can you retrieve the details of facilities with ID 1 and 5? Try to do it 
without using the OR operator. */
SELECT * 
FROM cd.facilities 
WHERE facid IN (1,5);

/* 07 - How can you produce a list of members who joined after the start of September
2012? Return the memid, surname, firstname, and joindate of the members in question. */
SELECT memid, surname, firstname, joindate 
FROM cd.members 
WHERE joindate >= '2012-09-01';

/* 08 - How can you produce an ordered list of the first 10 surnames in the members 
...
/* 09 - You'd like to get the signup date of your last member. How can you retrieve
this information? */
SELECT MAX(joindate) AS latest_signup 
FROM cd.members;

/* 10 - Produce a count of the number of facilities that have a cost to guests of 10
or more. */
SELECT COUNT(*) 
FROM cd.facilities 
WHERE guestcost >= 10;
...
of September 2012. Produce an output table consisting of facility id and slots, sorted 
...
/* 12 - Produce a list of facilities with more than 1000 slots booked. Produce an output 
